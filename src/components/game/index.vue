...
<script>
    ...
    import CSGOGame from '@/components/game/csgo/csgoGame' // csgo 比赛详情 1
    import LOLGame from '@/components/game/lol/lolGame'    // lol  比赛详情 2
    import DotaGame from '@/components/game/dota/dotaGame' // dota 比赛详情 3
